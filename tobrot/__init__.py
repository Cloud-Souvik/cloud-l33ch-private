...
try:
    ...
    YTDL_COMMAND = os.environ.get("YTDL_COMMAND", "ytttdl@tlx_sergio_pvt_bot")
    GYTDL_COMMAND = os.environ.get("GYTDL_COMMAND", "gytdl")
    SAVE_THUMBNAIL = os.environ.get("SAVE_THUMBNAIL", "savethumb@tlx_sergio_pvt_bot")
    RENAME_COMMAND = os.environ.get("RENAME_COMMAND", "rename@tlx_sergio_pvt_bot")
...
STATUS_COMMAND = os.environ.get("STATUS_COMMAND", "status@tlx_sergio_pvt_bot")
#SAVE_THUMBNAIL = os.environ.get("SAVE_THUMBNAIL", "savethumbnail")
CLEAR_THUMBNAIL = os.environ.get("CLEAR_THUMBNAIL", "clearthumbnail@tlx_sergio_pvt_bot")
